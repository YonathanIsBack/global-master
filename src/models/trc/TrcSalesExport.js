...
class TrcSalesExport extends StandardModel { }
...
TrcSalesExport.init(
  ...
  StandardModel.buildStandardModelInformation('trc_sales_export', 'TrcSalesExport', sequelize)
);

export default TrcSalesExport;