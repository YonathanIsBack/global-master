...
class TrcOffshorePurchase extends StandardModel { }

TrcOffshorePurchase.init(
  ...
  StandardModel.buildStandardModelInformation('trc_offshore_purchase', 'TrcOffshorePurchase', sequelize)
);

export default TrcOffshorePurchase;