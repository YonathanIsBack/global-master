...
class TrcPurchaseLocal extends StandardModel { }

TrcPurchaseLocal.init(
  ...
  StandardModel.buildStandardModelInformation('trc_purchase_local', 'TrcPurchaseLocal', sequelize)
);

export default TrcPurchaseLocal;