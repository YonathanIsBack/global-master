...
class ImportCreditNoteController extends StandardTransactionController {
  ...
  async create(request, response) {
    ...
    return await super.insertTransaction(request, response, importCreditNoteDto);
  }
...
export { ImportCreditNoteController, ImportCreditNoteDtController, ImportCreditNoteRejectController, ImportCreditNoteRequestController };
